...
public class Main {
    ...
    private static final String MARKET = "IL";
    private static final String EXCHANGE = "TASE";
    private static final String SYMBOL = "TASE:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"TASE:000040\",\"TASE:005930\"],\"replay\":\"last\"}";
